package tz15_bigdata_root.es.admin;
...
import tz15_bigdata_root.common.file.FileCommon;
import tz15_bigdata_root.es.client.ESclientUtil;
    ...
    public static boolean buildIndexAndMapping(String index,
        ...
        try {
            ...
            if(indices){
                ...
                flag = false;
                LOG.error("索引"+ index + "创建失败,请检查是否已经存在"+index);
            }
        } catch (Exception e) {
            flag = false;
