        ...
        if(hiveContext == null ){
            synchronized (HiveConf.class){
                if(hiveContext==null){
                    ...
                    System.load("E:\\Hadoop\\hadoop-2.8.4\\bin\\hadoop.dll");
                    System.load("E:\\Hadoop\\hadoop-2.8.4\\bin\\winutils.exe");
                    ...
                    hiveContext.setConf("hive.metastore.uris", "thrift://bigdata111:3306");
                }
            }
        }
        return hiveContext;
