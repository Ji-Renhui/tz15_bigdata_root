package tz15_bigdata_root.spark.warn.timer;

import org.apache.commons.lang.StringUtils;
import org.apache.log4j.Logger;
import redis.clients.jedis.Jedis;
import tz15_bigdata_root.redis.client.JedisUtil;
import tz15_bigdata_root.spark.warn.dao.TZ_RuleDao;
import tz15_bigdata_root.spark.warn.domain.TZ_RuleDomain;
    ...
    public void run() {
        ...
        try {
            for (int i = 0; i < ruleList.size(); i++) {
                ...
                jedis.hset(redisKey,"id",StringUtils.isNotBlank(id)?id:"");//redis 的Value不能为空
