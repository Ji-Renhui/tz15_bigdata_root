package tz15_bigdata_root.spark.sparkstreaming.kafka.utils
...
import tz15_bigdata_root.spark.sparkstreaming.kafka.offset.ManageOffsetRedis.saveOffSetToRedis

import scala.collection.JavaConversions._

//class KafkaHelper(val kafkaParams:java.util.Map[String,String],isUpdate:Boolean=true) extends Serializable with Logging{
