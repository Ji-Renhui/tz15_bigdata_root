...
import tz15_bigdata_root.spark.warn.dao.WarningMessageDao
import tz15_bigdata_root.spark.warn.domain.WarningMessage
import tz15_bigdata_root.spark.warn.timer.PhoneWarnImpl
...
/**
  ...
  */
object BlackWarnTask extends Serializable with Logging{
  /**
    * 黑名单预警   有嫌疑或者已经确定的目标
    * @param DS
    */
